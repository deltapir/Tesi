...
Ritornando ai risultati ottenuti, considerando che l'AOU ``Federico II'' compra da \emph{Studium Power\&Service} (che possiede tutta la centrale termofrigorifera) energia elettrica e termica è possibile valutare il risparmio annuale \emph{convenzionale} che si ottiene effettuando gli interventi ipotizzati in questo elaborato di laurea. 
...
\end{itemize}
Il risparmio annuale convenzionale sarà, quindi:
\begin{itemize}
	\item \num{18}\ k\euro\- di energia termica; %0.267 euro/mc di gas
	\item \num{9.7}\ k\euro\- di energia elettrica.
\end{itemize}
